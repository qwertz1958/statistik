...
abstract class DispatcherTest extends TestCase
{
    ...
    public function provideFoundDispatchCases()
    {
        ...
        // 7 ----- MyTest GET method fallback on HEAD route miss ------------------------------------>
        ...
        // 8 ----- MyTest GET method fallback on HEAD route miss ------------------------------------>
        ...
        // 9 ----- MyTest GET method fallback on HEAD route miss ------------------------------------>
        ...
        // 10 ---- MyTest existing HEAD route used if available (no fallback) ----------------------->
